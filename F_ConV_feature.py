...
from utils import get_loss_outlier_conv
...
def validate_react(dinov2, flow, loader):
    dinov2.cuda()
    dinov2.eval()
    flow.cuda()
    flow.eval()
    ...
    with torch.no_grad():
        ...
        for img, labels in loader:
            ...
            with autocast():
                ...
                distance = torch.mean(z1 ** 2, dim=1)
                # prob = torch.sigmoid(distance/100000)
        ...
        for epoch in range(opt.max_epoch):
            ...
            for idx, (features, class_l) in enumerate(tqdm(train_loader)):
                ...
                with autocast():
                    ...
                    shape_loss, consistent_loss, loss = get_loss_outlier_conv(
                        feature1, feature2, 
                        jac1, 
                        class_l, 
                        margin=2000
